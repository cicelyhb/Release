            ...
            private function Notes($notes_)
            {
                ...
                foreach($notes->note as $note){
                    ...
                    {                          
                          ...
                          if($note->content==""){
                                $value[] = '<p><h4><b>Posted: '.$note->date.'</b><br>['.$note->typedescription.']</h4><h5>'.$note->username.'</h5></p>';
                          }else {
                                $value[] = '<p><h4><b>Posted: '.$note->date.'</b><br>'.$note->content.'<br>['.$note->typedescription.']</h4><h5>'.$note->username.'</h5></p>';
                          }                      
                    }
                    if ($node==2)
                    {
...
//                }  
               ...
               if ($column[5]=="NTR")
               {
                   echo $sngquote.'<option value="NTR" selected>No Trespassing</option>'.$sngquote.' +',PHP_EOL;  
               }
               else
               {
                   echo $sngquote.'<option value="NTR">No Trespassing</option>'.$sngquote.' +',PHP_EOL;  
               }                           
...
//            }  
           ...
           echo $sngquote.'<tr><td><select id="PhoneType">'.$sngquote.' +',PHP_EOL;   
            ...
            if ($column[7]=="PD")
            {
                echo $sngquote.'<option value="PD" selected>Phone Disconnected</option>'.$sngquote.' +',PHP_EOL;  
            }
            else
            {
                echo $sngquote.'<option value="PD">Phone Disconnected</option>'.$sngquote.' +',PHP_EOL;  
            } 
           ...
           echo $sngquote.'<div class="tooltip"><img src = "icons/Phone_Small.png">'.$sngquote.' +',PHP_EOL;              
